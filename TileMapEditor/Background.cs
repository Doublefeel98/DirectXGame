...
namespace MapEditor
{
    public partial class Background : Form
    {
        ...
        private void textBoxChuaLoc_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxDaLoc_TextChanged(object sender, EventArgs e)
        {
        ...
        private void textBoxBGWidth_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxBGHeigth_TextChanged(object sender, EventArgs e)
        {
