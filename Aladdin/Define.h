...
#define NORMAL_GUARD_ANI_WAIT								0
#define NORMAL_GUARD_ANI_STAB								1			
#define NORMAL_GUARD_ANI_WAVE								2
#define NORMAL_GUARD_ANI_SURPRISE							3
#define NORMAL_GUARD_ANI_JUMP								4
#define NORMAL_GUARD_ANI_DIE								5
#define NORMAL_GUARD_ANI_DIE_SHADOW						6
