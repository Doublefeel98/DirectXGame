...
MusclePalaceGuard::MusclePalaceGuard() :CGameObject() {
...
void MusclePalaceGuard::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
...
void MusclePalaceGuard::Update(DWORD dt, vector<LPGAMEOBJECT>* coObject) {
